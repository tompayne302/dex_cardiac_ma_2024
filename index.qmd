...
prob_tbl1 <- as.data.frame(rbind("Overall" = c("Overall", "Overall", Rc_overall, probs_overall),
     ...
     "Morphine" = c("Morphine", "Control agent", Rc_overall, probs_intraop),
     "Normal saline" = c("Normal saline", "Control agent", Rc_overall, probs_intraop_postop),
     "Propofol" = c("Propofol", "Control agent", Rc_overall, probs_postop))) %>%
